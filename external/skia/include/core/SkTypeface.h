...
public:
    ...
    */
    ...
    /** Added for FlipFont. Allows Flipfont to set or clear the bold font flag 
        after flipping        
    */
    void setBold(bool bBold) { if (bBold) fStyle = kBold; else fStyle = kNormal; }
    ...
    */
    static bool isValidStream(SkStream* stream);
    /* SAMSUNG CHANGE << */    
