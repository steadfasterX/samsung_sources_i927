...
#ifdef QIC_OPT_FIX
	Node* locateCousinList(Element* parent, unsigned& visitedNodesCount);
#else
...
#if _SISO_CSS_OPT_
		// Match the descendent rules
		void matchDescRulesForList(Element* e,CSSRuleSet* rules, AtomicStringImpl* localNameImpl, unsigned int index, int& firstRuleIndex, int& lastRuleIndex);
#endif
