...
//__android_log_print(ANDROID_LOG_DEBUG, "Paint ", "InlineTextBox::paintCompositionUnderline %d" , ctx); //NAGSM_DeleteLog
    ...
    int start = 0;                 // start of line to draw, relative to tx
    int width = m_width;           // how much line to draw
// __android_log_print(ANDROID_LOG_DEBUG, "Inline ", " Inline start %d m_width %d" , start ,  width  );//NAGSM_DeleteLog
    ...
    if (m_truncation != cNoTruncation) {
//	__android_log_print(ANDROID_LOG_DEBUG, "Inline ", " m_truncation != cNoTruncation "  );//NAGSM_DeleteLog
...
//	 __android_log_print(ANDROID_LOG_DEBUG, "Inline ", " Inline start %d toRenderText width %d" , start ,  width  );//NAGSM_DeleteLog
    }
...
//		__android_log_print(ANDROID_LOG_DEBUG, "Inline ", " Inline  left:%f top:%f right:%f bot:%f " , left , top , right , bottom );//NAGSM_DeleteLog
...
//    	__android_log_print(ANDROID_LOG_DEBUG, "Inline ", " Inline start %d width %d" , start ,  width  );//NAGSM_DeleteLog
