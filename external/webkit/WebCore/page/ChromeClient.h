...
#if ENABLE(WRT)//WRT V8 changes
	virtual bool installCustomObjects(Frame* frame, v8::Handle<v8::Context>) = 0;
	virtual bool isEnableCustomObj(Frame* frame) = 0;
	virtual bool frameCleared(Frame* frame) = 0;
#endif//WRT V8 changes end
